...
-- ユニットテスト用テーブル作成
CREATE TABLE article_test (id INTEGER AUTO_INCREMENT PRIMARY KEY NOT NULL,title VARCHAR(100) NOT NULL,content VARCHAR(1000) NOT NULL,created DATE NOT NULL);
