...
func DB(t *testing.T) *sql.DB {
	...
	_, err = d.Exec(`
		...
		VALUES
		 	(1, 'ブログはじめました', 'このブログではわたしの個人的な事柄について書くつもりです。', '2023-12-07'),
			(2, '仕事について', 'わたしは新卒のころからずっと続けている仕事があります。', '2023-12-07'),
			(3, 'こんなことがありました', '先日、散歩をしていた時に変な出来事に遭遇しました。', '2023-12-07'),
			(4, '自己紹介', 'わたしの自己紹介をさせてください。', '2023-12-07')
	`)
